...
class CapitalRotationMetricTest {
  ...
  class ScoreDispersionMetricTests {
    ...
    void noDispersion() {
      List<ThemeSummaryDto> flat =
          List.of(theme(0.60, 0.01), theme(0.60, 0.01), theme(0.60, -0.01), theme(0.60, 0.01));
    ...
    void highDispersion() {
      List<ThemeSummaryDto> spread =
          List.of(theme(0.10, -0.02), theme(0.20, -0.01), theme(0.80, 0.01), theme(0.90, 0.02));
    ...
    void moderateDispersion() {
      List<ThemeSummaryDto> themes =
          List.of(theme(0.40, -0.01), theme(0.50, 0.00), theme(0.65, 0.01), theme(0.75, 0.02));
    ...
    void nullScoresExcluded() {
      List<ThemeSummaryDto> themes =
          List.of(theme(null, 0.01), theme(0.40, 0.01), theme(0.60, 0.01), theme(0.80, 0.01));
  ...
  class TrendAlignmentMetricTests {
    ...
    void noEligibleThemes() {
      List<ThemeSummaryDto> themes = List.of(theme(null, 0.01), theme(0.80, null));
      assertThat(metric.compute(themes)).isCloseTo(0.0, offset(0.001));
    }
