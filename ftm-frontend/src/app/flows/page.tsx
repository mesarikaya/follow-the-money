  ...
  return (
    ...
    >
      <div className="space-y-2">
        <div className="flex items-center justify-between text-xs text-zinc-500 px-3 mb-3">
          <span>Category</span>
        ...
        {MOCK_FLOW_DATA.map((row) => {
          ...
          return (
            <div key={row.categoryName} className="flex items-center gap-3 bg-zinc-800/40 border border-zinc-700/50 rounded-md px-3 py-2">
              <span className="w-40 text-sm text-zinc-300 shrink-0">{row.categoryName}</span>
        ...
        <div className="flex items-center gap-2 pt-2 text-xs text-zinc-600">
          <div className="w-3 h-1 bg-zinc-600 rounded" />
