 ...
 *
 * <p>RS_Ratio(t) = 100 + EMA(RS_20, 10)(t) × 100 RS_Momentum(t) = 100 + (RS_Ratio(t) -
 * EMA(RS_Ratio, 5)(t)) × 20
 *
 * <p>Quadrant encoding: Leading=4, Improving=3, Weakening=2, Lagging=1
 */
@Component
  ...
  public List<BigDecimal> computeMomentumSeries(List<BigDecimal> ratioSeries, int emaPeriod) {
    ...
    for (int i = 0; i < ratioSeries.size(); i++) {
      ...
      if (ratio == null || emaVal == null) {
        ...
        result.add(
            HUNDRED
                .add(ratio.subtract(emaVal, MC).multiply(TWENTY, MC))
