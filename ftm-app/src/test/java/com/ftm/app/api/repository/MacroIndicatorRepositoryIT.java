...
class MacroIndicatorRepositoryIT {
    ...
    @Autowired
    MacroIndicatorReadRepository repository;
    ...
    private void insert(LocalDate date, String seriesId, String value) {
        jdbcTemplate.update(
                ...
                date, seriesId, new BigDecimal(value));
    }
    ...
    void shouldReturnLatestObservationPerSeries() {
        ...
        MacroIndicator dgs10 = result.stream().filter(m -> m.seriesId().equals("DGS10")).findFirst().orElseThrow();
