...
/**
 * Computes the percentile rank of the current composite score within the history window.
 * A value of 0.80 means the current score is above 80% of recent history.
 */
@Component
