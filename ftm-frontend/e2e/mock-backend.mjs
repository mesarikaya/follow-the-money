...
const THEMES_RESPONSE = [
  {
    ...
    phaseTransitionSignal: "BREAKOUT_CONFIRMED", riskLevel: "LOW", entryAction: "ADD", entryRationale: "Strong momentum with breakout confirmed", momentumAlignment: "ALIGNED", confluenceScore: 82, confidenceLabel: "HIGH",
    topConstituents: [
  ...
  },
  {
    ...
    riskLevel: "LOW", confluenceScore: 68, confidenceLabel: "MODERATE",
    topConstituents: [
      { categoryId: "SEMI", parentCategoryId: "TECH", name: "Semiconductors", etfTicker: "SMH", compositeScore: 0.88, rs60: 0.09, flow20d: 1.8, compositeTrend20d: 0.025, tradeSignal: "BUY", convictionScore: 90 },
      { categoryId: "AIRO", parentCategoryId: "TECH", name: "AI & Robotics", etfTicker: "BOTZ", compositeScore: 0.82, rs60: 0.07, flow20d: 1.5, compositeTrend20d: 0.020, tradeSignal: "BUY", convictionScore: 82 },
  ...
  },
  {
    ...
    phaseTransitionSignal: "FADING_ACCELERATING", riskLevel: "HIGH", entryAction: "REDUCE", entryRationale: "Fading trend with increasing volatility", confluenceScore: 22, confidenceLabel: "LOW",
    topConstituents: [
  ...
  },
  {
    ...
    riskLevel: "LOW", confluenceScore: 75, confidenceLabel: "HIGH",
    topConstituents: [
  ...
  },
  {
    ...
    riskLevel: "MEDIUM", confluenceScore: 45, confidenceLabel: "MODERATE",
    topConstituents: [
  ...
  },
  {
    ...
    riskLevel: "MEDIUM", confluenceScore: 40, confidenceLabel: "LOW",
    topConstituents: [
  ...
  },
  {
    ...
    phaseTransitionSignal: "SETUP_CONFIRMED", riskLevel: "MEDIUM", entryAction: "WATCH", confluenceScore: 58, confidenceLabel: "MODERATE",
    topConstituents: [
  ...
  },
  {
    ...
    riskLevel: "LOW", confluenceScore: 70, confidenceLabel: "MODERATE",
    topConstituents: [
      { categoryId: "AIRO", parentCategoryId: "TECH", name: "AI & Robotics", etfTicker: "BOTZ", compositeScore: 0.82, rs60: 0.07, flow20d: 1.5, compositeTrend20d: 0.020, tradeSignal: "BUY", convictionScore: 82 },
  ...
  },
  {
    ...
    riskLevel: "LOW", entryAction: "ADD", entryRationale: "Sustained momentum with low volatility", confluenceScore: 88, confidenceLabel: "HIGH",
    topConstituents: [
  ...
  },
  {
    ...
    riskLevel: "MEDIUM", confluenceScore: 48, confidenceLabel: "MODERATE",
    topConstituents: [
  ...
  },
  {
    ...
    riskLevel: "MEDIUM", confluenceScore: 52, confidenceLabel: "MODERATE",
    topConstituents: [
  ...
  },
  {
    ...
    riskLevel: "LOW", entryAction: "ADD", entryRationale: "Reshoring cycle in sustained momentum", confluenceScore: 78, confidenceLabel: "HIGH",
    topConstituents: [
