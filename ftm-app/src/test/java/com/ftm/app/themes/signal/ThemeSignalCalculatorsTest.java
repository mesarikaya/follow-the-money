...
class ThemeSignalCalculatorsTest {
  ...
  class ConcentrationRiskCalculatorTests {
    ...
    private final ThemeConcentrationRiskCalculator calculator = new ThemeConcentrationRiskCalculator();

    private ThemeConstituentDto constituent(String categoryId, String parentCategoryId) {
      return new ThemeConstituentDto(categoryId, parentCategoryId, categoryId, "", null, null, null, null, null, "HOLD", null);
    }
    ...
    void returnsOneWhenFullConcentration() {
      List<ThemeConstituentDto> constituents = List.of(
          constituent("SEMI", "TECH"),
          constituent("AIRO", "TECH"));
    ...
    void usesCategoryIdWhenNoParent() {
      List<ThemeConstituentDto> constituents = List.of(
          constituent("SEMI", null),
          constituent("SEMI2", null));
