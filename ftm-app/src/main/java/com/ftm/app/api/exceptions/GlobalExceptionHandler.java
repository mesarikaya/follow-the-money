...
public class GlobalExceptionHandler {
    ...
    public static final String HTTPS_FTM_LOCAL_ERRORS_VALIDATION = "https://ftm.local/errors/validation";
    ...
    // Spring MVC 7 dispatches @RequestParam / @PathVariable violations as HandlerMethodValidationException
    ...
    public ProblemDetail handleGeneric(Exception ex, WebRequest request) {
        ...
        ProblemDetail problem = ProblemDetail.forStatusAndDetail(INTERNAL, "An unexpected error occurred");
