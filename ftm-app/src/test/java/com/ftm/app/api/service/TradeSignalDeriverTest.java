...
class TradeSignalDeriverTest {
  ...
  void convictionScoreShouldBeZeroWhenScoreNull() {
    assertThat(TradeSignalDeriver.convictionScore(
        ...
        new BigDecimal("0.80"), new BigDecimal("0.90"), new BigDecimal("0.03"), null, null, null, null))
        .isEqualTo(0);
  }
  ...
  void convictionScoreWatchWithOneBuyConditionReturnsZero() {
    ...
    int conviction = TradeSignalDeriver.convictionScore(
        ...
        new BigDecimal("0.70"), new BigDecimal("0.75"), new BigDecimal("0.01"), null, null, null, null);
  ...
  void convictionScoreShouldAddFlowBonusForReduceWithNegativeFlowZ() {
    ...
    int withFlowConviction = TradeSignalDeriver.convictionScore(
        new BigDecimal("0.28"), "1", new BigDecimal("-0.02"),
        new BigDecimal("0.30"), new BigDecimal("0.25"), new BigDecimal("-0.01"),
        null, null, new BigDecimal("-2.0"), null);  // flow z = -2.0 (below -1.5 threshold)
  ...
  void convictionScoreShouldAddRs20AlignedBonusForBuyWithAllRsAligned() {
    ...
    int baseConviction = TradeSignalDeriver.convictionScore(
        new BigDecimal("0.70"), "4", new BigDecimal("0.02"),
        new BigDecimal("0.60"), new BigDecimal("0.70"), new BigDecimal("0.03"),
        new BigDecimal("0.05"), new BigDecimal("0.02"), null, null);

    // Same but with RS-20 = 0.08 > RS-60 = 0.05 > RS-120 = 0.02 — all aligned bullish → +5 pts
    int withRs20Conviction = TradeSignalDeriver.convictionScore(
        new BigDecimal("0.70"), "4", new BigDecimal("0.02"),
        new BigDecimal("0.60"), new BigDecimal("0.70"), new BigDecimal("0.03"),
        new BigDecimal("0.05"), new BigDecimal("0.02"), null, new BigDecimal("0.08"));
