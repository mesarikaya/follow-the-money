...
/**
 * Computes the standard deviation of daily composite score changes over the history window.
 * Returns null when history has fewer than 3 points (insufficient data).
 */
@Component
