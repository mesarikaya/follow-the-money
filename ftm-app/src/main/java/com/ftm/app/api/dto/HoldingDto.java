...
public record HoldingDto(
    ...
    @Schema(description = "Latest price in the holding's local currency from Yahoo Finance; null if not yet fetched")
    ...
    @Schema(description = "Source of the latest price: 'yahoo_finance' or null if not fetched")
        String priceSource,
    @Schema(description = "Market value in EUR (quantity × currentPriceLocal, converted if USD); null if no current price")
