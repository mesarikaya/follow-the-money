...
const THEMES_RESPONSE = [
  {
    ...
    bullishCount: 5, dominantSignal: "BUY", divergenceFromParentSectors: 0.14, themePhase: "BREAKOUT", alertCount30d: 12, signalStreakDays: 30, volatility30d: 0.022,
    topConstituents: [
  ...
  },
  {
    ...
    bullishCount: 3, dominantSignal: "WATCH", divergenceFromParentSectors: 0.09, themePhase: "MOMENTUM", alertCount30d: 7, signalStreakDays: 14, volatility30d: 0.018,
    topConstituents: [
      { categoryId: "SEMI", parentCategoryId: "TECH", name: "Semiconductors", etfTicker: "SMH", compositeScore: 0.88, rs60: 0.09, flow20d: 1.8, compositeTrend20d: 0.025, tradeSignal: "BUY", convictionScore: 90 },
      { categoryId: "AIRO", parentCategoryId: "TECH", name: "AI & Robotics", etfTicker: "BOTZ", compositeScore: 0.82, rs60: 0.07, flow20d: 1.5, compositeTrend20d: 0.020, tradeSignal: "BUY", convictionScore: 82 },
  ...
  },
  {
    ...
    bullishCount: 0, dominantSignal: "REDUCE", divergenceFromParentSectors: -0.18, themePhase: "FADING", alertCount30d: 3, signalStreakDays: 8, volatility30d: 0.045,
    topConstituents: [
  ...
  },
  {
    ...
    bullishCount: 2, dominantSignal: "WATCH", divergenceFromParentSectors: 0.06, themePhase: "BREAKOUT", alertCount30d: 5, signalStreakDays: 22, volatility30d: 0.015,
    topConstituents: [
  ...
  },
  {
    ...
    bullishCount: 2, dominantSignal: "WATCH", divergenceFromParentSectors: 0.03, themePhase: "BUILDING", alertCount30d: 2, signalStreakDays: 12, volatility30d: 0.028,
    topConstituents: [
  ...
  },
  {
    ...
    bullishCount: 2, dominantSignal: "WATCH", divergenceFromParentSectors: 0.04, themePhase: "BUILDING", alertCount30d: 1, signalStreakDays: 9, volatility30d: 0.032,
    topConstituents: [
  ...
  },
  {
    ...
    bullishCount: 3, dominantSignal: "WATCH", divergenceFromParentSectors: 0.07, themePhase: "SETUP", alertCount30d: 4, signalStreakDays: 18, volatility30d: 0.020,
    topConstituents: [
  ...
  },
  {
    ...
    bullishCount: 3, dominantSignal: "WATCH", divergenceFromParentSectors: 0.08, themePhase: "MOMENTUM", alertCount30d: 8, signalStreakDays: 16, volatility30d: 0.017,
    topConstituents: [
      { categoryId: "AIRO", parentCategoryId: "TECH", name: "AI & Robotics", etfTicker: "BOTZ", compositeScore: 0.82, rs60: 0.07, flow20d: 1.5, compositeTrend20d: 0.020, tradeSignal: "BUY", convictionScore: 82 },
  ...
  },
  {
    ...
    bullishCount: 4, dominantSignal: "BUY", divergenceFromParentSectors: 0.11, themePhase: "MOMENTUM", alertCount30d: 6, signalStreakDays: 25, volatility30d: 0.012,
    topConstituents: [
  ...
  },
  {
    ...
    bullishCount: 3, dominantSignal: "WATCH", divergenceFromParentSectors: 0.06, themePhase: "SETUP", alertCount30d: 3, signalStreakDays: 10, volatility30d: 0.040,
    topConstituents: [
  ...
  },
  {
    ...
    bullishCount: 3, dominantSignal: "WATCH", divergenceFromParentSectors: 0.04, themePhase: "BUILDING", alertCount30d: 2, signalStreakDays: 15, volatility30d: 0.025,
    topConstituents: [
  ...
  },
  {
    ...
    bullishCount: 4, dominantSignal: "BUY", divergenceFromParentSectors: 0.09, themePhase: "MOMENTUM", alertCount30d: 4, signalStreakDays: 20, volatility30d: 0.016,
    topConstituents: [
