...
/**
 * Computes concentration risk as the fraction of constituents in the dominant parent sector. A
 * value of 1.0 means all constituents share a single parent sector (maximum concentration).
 */
@Component
