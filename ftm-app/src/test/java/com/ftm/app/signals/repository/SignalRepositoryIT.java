...
class SignalRepositoryIT {
    ...
    void shouldUpdateValueOnConflict() {
        var initial = List.of(new SignalRepository.Row(DATE, TECH, SignalType.RS_60, new BigDecimal("1.000000")));
        repository.batchUpsert(initial);

        var updated = List.of(new SignalRepository.Row(DATE, TECH, SignalType.RS_60, new BigDecimal("1.100000")));
    ...
    void shouldReturnLatestSignalByType() {
        var older = new SignalRepository.Row(DATE.minusDays(1), TECH, SignalType.RS_60, new BigDecimal("0.990000"));
    ...
    void shouldReturnHistoryOrderedByDate() {
        repository.batchUpsert(List.of(
                new SignalRepository.Row(DATE, TECH, SignalType.RS_60, new BigDecimal("1.050000")),
                new SignalRepository.Row(DATE.minusDays(1), TECH, SignalType.RS_60, new BigDecimal("1.040000"))
        ));
