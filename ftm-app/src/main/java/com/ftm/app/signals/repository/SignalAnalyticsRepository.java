...
/**
 * The derived questions we ask of the signal history — rotation trails, realised volatility, how
 * long a signal has held, how past BUY signals actually performed, where a score sits in its own
 * 252-day range. These are analytical queries with their own SQL; the plain reads and writes of
 * individual signals live in {@link SignalRepository}.
 */
@Repository
public class SignalAnalyticsRepository {

  private final DSLContext dsl;

  public SignalAnalyticsRepository(DSLContext dsl) {
    this.dsl = dsl;
  }
