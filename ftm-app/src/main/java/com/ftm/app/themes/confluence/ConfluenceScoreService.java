...
/**
 * Computes a 0-100 confluence score by summing weighted factor contributions.
 * Each factor scores [-3, +3]; the weighted average is normalised to [0, 100].
 * Labels: HIGH_CONFIDENCE (≥70), MODERATE (≥50), CAUTIOUS (≥35), AVOID (<35).
 */
@Component
